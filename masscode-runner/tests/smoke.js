...
`);
 ...
 assert(html.includes('/monaco/vs/loader.js') && html.includes('id="monaco-main"') && html.includes('syncMonacoMain') && html.includes('multiCursorModifier'), 'Monaco / VS Code 同源编辑内核缺失');
  ...
  assert(html.includes('id="xmind-view-official"') && html.includes('id="xmind-official-consent"') && html.includes('openXmindOfficialView') && html.includes('/xmind-viewer/xmind-embed-viewer.js') && html.includes('www.xmind.cn'), 'XMind 缺少带隐私确认的官方全画布查看器');
