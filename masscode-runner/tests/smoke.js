...
`);
  ...
  assert(environment.env.onlyoffice && environment.env.onlyoffice.external && /本地兼容模式/.test(environment.env.onlyoffice.issue) && /无需安装/.test(environment.env.onlyoffice.hint), 'ONLYOFFICE 外部服务或离线回退说明不完整');
