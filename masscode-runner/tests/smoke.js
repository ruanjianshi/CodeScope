...
`);
  ...
  assert(environment.env.onlyoffice && /本地兼容模式/.test(environment.env.onlyoffice.issue) && /无需安装/.test(environment.env.onlyoffice.hint), 'ONLYOFFICE 离线回退说明不完整或被覆盖');
