...
当前正式版本：**v2.1.2**。版本变更见 [CHANGELOG.md](CHANGELOG.md)。
...
| 🔍 环境 | 分为“运行基础 / 浏览器能力 / 项目工具链”：检查 Node 版本、Vault/应用数据/临时目录权限、npm 依赖、ONLYOFFICE、浏览器编辑能力，并按 vault 实际语言检测编译器、解释器、LSP、LaTeX 和 SSH；显示平台、架构、发行版与包管理器，每 60 秒自动复检，可一键配置当前项目缺失工具 |
